...
class Team:
    ...
    def __init__(self, engine, color: Color, goal: Goal, attackDir):
        self.engine = engine
        self.color: Color = color
        self.goal: Goal = goal
        self.attackDir: int = attackDir
        ...
        self.PITCH_MARGIN_X: int = int((InternalProperties.SCREEN_WIDTH - InternalProperties.PITCH_WIDTH) / 2)
        self.PITCH_MARGIN_Y: int = int((InternalProperties.SCREEN_HEIGHT - InternalProperties.PITCH_HEIGHT) / 2)
    ...
    def resetPositions(self):
        ...
        pitchHalfSize: pygame.Vector2 = pygame.Vector2(
            InternalProperties.PITCH_WIDTH / 2,
            InternalProperties.PITCH_HEIGHT
        )

        for i in range(agentsNum):
            posOnPitchHalf: pygame.Vector2 = (pitchHalfSize.elementwise() * self.layout[layoutAgentsNum][i].elementwise())
